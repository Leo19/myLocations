...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func listenForFatalCoreDataNotifications(){
        NSNotificationCenter.defaultCenter().addObserverForName(MyManagedObjectContextSaveDidFailNotification, object: nil, queue: NSOperationQueue.mainQueue(), usingBlock: {
            notification in
            let alert = UIAlertController(title: "Internal Error", message: "There was a fatal error in the app Sorry!", preferredStyle: .ActionSheet)
    ...
    // 为了让这个alert出来，得给一个当前可见的view controller
